...
//   );
// }
// components/NEETTitleSection.jsx
    ...
    {/*Registration process */}
     <section className="lg:px-20 my-16 p-6 bg-white rounded-xl shadow-lg">
      <h2 className="text-3xl font-semibold text-gray-800 text-center mb-8">
        NEET  Registration & Counselling Process
      </h2>

      {/* Registration Process */}
      <div className="mb-8">
        <h3 className="text-2xl font-semibold text-gray-700 mb-4">Registration Process (Step-by-Step)</h3>
        <ol className="list-decimal list-inside space-y-3 text-gray-700 text-lg">
          <li>
  Visit the official NEET website&nbsp;
  <a href="https://nta.ac.in" target="_blank" rel="noopener noreferrer" className="text-blue-600 hover:underline">
    (nta.ac.in)
  </a>
</li>

          <li>Click on the "New Registration" link and fill in the required personal details.</li>
          <li>Note down the generated application number for future login.</li>
          <li>Fill the complete application form including academic & communication details.</li>
          <li>Upload scanned images of passport-size photograph, signature & required documents.</li>
          <li>Pay the application fee online via Debit/Credit Card/Net Banking/UPI.</li>
          <li>Download the confirmation page and keep it for future reference.</li>
        </ol>
      </div>

      {/* Counselling Process */}
      <div>
        <h3 className="text-2xl font-semibold text-gray-700 mb-4">Counselling Process (Step-by-Step)</h3>
        <ol className="list-decimal list-inside space-y-3 text-gray-700 text-lg">
          <li>Register online on the official MCC or state counselling portal.</li>
          <li>Fill choices of colleges and courses in order of preference.</li>
          <li>Lock the filled choices before the last date.</li>
          <li>Seat allotment results will be declared based on NEET rank, choices, and reservation criteria.</li>
          <li>Download the seat allotment letter if a seat is allotted.</li>
          <li>Report to the allotted college with original documents for verification.</li>
          <li>If satisfied with the allotted seat, confirm admission; otherwise, participate in the next counselling round.</li>
        </ol>
      </div>
    </section>
    </div>
